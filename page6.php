    ...
    <div class="content">
        ...
        <div class="check__block">
            ...
            <div class="check__block__info">
                <p>Предоставление проекта договора со всеми прилагаемыми к нему документами на 3 дня до подписания договора и право на полное разъяснение</p>
                <div class="card">
                    <div class="card-header" id="headingOne">
                        <span class="mb-0" role="button" data-target="#collapseOne" data-toggle="collapse"
                            ...
                            <button class="btn btn-link" type="button">
                                ...
                                <span class="title__card">Вот для вас проект договора о кредите.</span>
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne"
                        ...
                        <div class="card-body">
                            Я попрошу Вас, ещё раз всё очень тщательно прочитать. Пожалуйста, отметьте всё, что Вам будет непонятно, чтобы мы могли объяснить. Вы также можете обратиться за внешней консультацией. Позвольте позвонить вам через три дня и в случае согласия, договориться о встрече для подписания договора.
        <br>Также даю Вам чеклист, в котором написаны ваши права и обязанности как потребителя. Попрошу вас сообщить нам обо всех изменениях, влияющих на выполнение договора, например, если у Вы сменили адрес проживания.
            ...
            <div class="check__block__info">
                ...
                <div class="card">
                    ...
                    <div id="collapse2" class="collapse" aria-labelledby="heading2"
                        data-parent="#accordionExample">
                        <div class="card-body">
                            Вот ваша копия договора. Мы желаем Вам удачи при осуществлении Ваших планов. И, пожалуйста, всегда обращайтесь к нам, если возникнут какие-либо вопросы.
                        </div>
                    </div>
                </div>
            </div>
